...
sealed class Type {
    ...
    data class SimpleType(override val typeName: TypeName, val default: Any? = null) : Type()
    ...
    companion object {
        fun <T: TypeName> T.simpleType(nullable: Boolean = false, default: Any? = null): SimpleType = SimpleType(this.copy(nullable = nullable), default)
    }
}